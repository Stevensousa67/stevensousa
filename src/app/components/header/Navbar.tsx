...
export default function Navbar() {
    ...
    return (
        <header>
            <nav className="sticky w-full z-20 top-0 left-0 mb-16" role="navigation">
                <div className="flex justify-center px-4 md:px-0">
                    <div className="inline-flex items-center px-6 py-3 bg-white/20 border border-white/30 rounded-full shadow-xl mt-5 backdrop-blur-lg transition-all w-full md:w-auto md:max-w-2xl lg:max-w-4xl">
                        <Link href='/' className="inline-block mr-2 md:mr-8">
                            <Image src='/Logo.jpeg' alt='Steven Sousa Logo Image' width={60} height={60} />
                        </Link>
