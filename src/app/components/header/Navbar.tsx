...
export default function Navbar() {
    ...
    return (
        <header>
            <nav className={`fixed w-full top-4 z-40 max-w-5xl flex h-[60px] items-center justify-between rounded-full px-8 saturate-100 backdrop-blur-[10px] transition-colors ${scrolled ? 'bg-background/80 shadow-xs border-transparent' : 'bg-background/30 shadow-xl border border-foreground/30'} animate-in fade-in slide-in-from-top-full duration-400 ease-out fill-mode-forwards`} style={{ left: '50vw', transform: 'translateX(-50%)' }} role="navigation">
