...
export default function Contact() {
  return (
    <section className="py-32 flex flex-col items-center text-center gap-8">
      ...
      <a href="https://www.linkedin.com/in/stevenssousa/" className="text-lg text-blue-500 hover:underline">LinkedIn</a>
      <a href="https://github.com/Stevensousa67" className="text-lg text-blue-500 hover:underline">GitHub</a>
    </section>
  )
}
