...
export default function Footer() {
  ...
  return (
    <footer className="bg-background/30 shadow-xs relative max-w-5xl mx-auto w-full mb-3 flex flex-col rounded-2xl p-8 saturate-100 backdrop-blur-[10px] overflow-hidden">
